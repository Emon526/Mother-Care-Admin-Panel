    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:pt-0">
                ...
                <img src="logo.png" alt="Logo" class="h-16 w-auto text-gray-700 sm:h-20" style="height: 10rem">

            </div>

            <div class="flex justify-center pt-8 ">
                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="40">
                    <text x="50%" y="50%" fill="#FF80AB" font-size="40" font-family="Lucida Sans" font-weight="bold"
                        text-anchor="middle" dominant-baseline="middle">Mother Care</text>
                </svg>
            </div>
